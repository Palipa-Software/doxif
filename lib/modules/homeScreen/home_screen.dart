                                  ...
                                  return Padding(
                                    ...
                                    child: Obx(
                                      () => PlantCard(
                                          editOnTap: (sensor) {
                                            print(
                                                "Name:${controller.myDataList[index].regionName}");
                                            print(
                                                "Type:${controller.myDataList[index].plantType}");
                                            print(
                                                "Variet:${controller.myDataList[index].plantVariet}");
                                            Get.to(() => EditRegion(
                                                  name: controller
                                                      .myDataList[index]
                                                      .regionName,
                                          ...
                                          highHumidity: controller
                                              .myDataList[index].maxNem,
                                          highTemp: controller
                                              .myDataList[index].maxSic,
                                          lowHumidity: controller
                                              .myDataList[index].minNem,
                                          lowTemp: controller
                                              .myDataList[index].minSic,
                                          onTap: () async {
                                            showDialog(
                                              context: context,
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: Obx(
                                      () => PlantCard(
                                        editOnTap: (sensor) {
                                          Get.offAll(EditRegion(
                                            name: controller
                                                .myDataList[index].regionName,
                                            type: controller
                                                .myDataList[index].plantType,
                                            varietValue: controller
                                                .myDataList[index].plantVariet,
                                            date: controller
                                                .myDataList[index].plantingDate,
                                            sID: controller
                                                .myDataList[index].sensorId,
                                          ));
                                        },
