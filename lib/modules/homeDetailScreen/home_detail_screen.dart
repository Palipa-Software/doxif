                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: Obx(
                                                            () => Text(
                                                              "Tarih: ${controller.chartDay.value.isEmpty ? HomeScreenController().yesterday : salesDataLists[pointInteractionDetails.pointIndex!].date}",
                                                              style: AppTextStyle
                                                                  .chartDialogText,
                                                            ),
                                                          ),
...
class SalesData {
  SalesData(this.time, this.datas, this.date);
  final String time;
  final double datas;
  final String date;
}
